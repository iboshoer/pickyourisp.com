...
Provider identification SVGs live under `public/assets/images/providers/` (moved from the static site). See `ATTRIBUTION.md` for nominative fair use notes. Soft launch keeps `noindex` and does not claim press features.
